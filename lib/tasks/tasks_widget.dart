...
class _TasksWidgetState extends State<TasksWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiresponse = await GetRandomQuotesCall.call();

      if ((_model.apiresponse?.succeeded ?? true)) {
        _model.quote = GetRandomQuotesCall.quote(
          (_model.apiresponse?.jsonBody ?? ''),
        )!;
        _model.author = GetRandomQuotesCall.author(
          (_model.apiresponse?.jsonBody ?? ''),
        )!;
        safeSetState(() {});
      }
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, listViewIndex) {
                        ...
                        return InkWell(
                          ...
                          child: TaskWidget(
                            key: Key(
                                'Keynfr_${listViewIndex}_of_${listViewTasksRecordList.length}'),
